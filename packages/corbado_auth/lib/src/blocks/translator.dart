...
const identifierErrorMap = {
  ...
  'identifier_already_in_use': {
    LoginIdentifierType.username:
        'This username is already taken. Please try another one or log in with this one.',
    LoginIdentifierType.email:
        'This email address is already taken. Please try another one or log in with this one.',
    LoginIdentifierType.phone:
        'This phone number is already taken. Please try another one or log in with this one',
  },
