...
/// Maps identifier-specific error codes to human readable messages per
/// [LoginIdentifierType].
const identifierErrorMap = {
  ...
  'identifier_already_in_use': {
    LoginIdentifierType.username:
        'This username is already taken. Please try another one or log in '
        'with this one.',
    LoginIdentifierType.email:
        'This email address is already taken. Please try another one or log '
        'in with this one.',
    LoginIdentifierType.phone:
        'This phone number is already taken. Please try another one or log '
        'in with this one',
  },
  'identifier_invalid_format': {
    LoginIdentifierType.username:
        'Username must be between 4 and 32 characters long and may only '
        'consist of alphanumeric characters and "-" or "_".',
    LoginIdentifierType.email: 'Please enter a valid email address.',
    LoginIdentifierType.phone: 'Please enter a valid phone number',
  },
};

/// Maps generic error codes to human readable messages.
const Map<String, String> errorMap = {
  ...
  'invalid_conditional_ui_login':
      'The provided passkey is no longer valid. Please enter your identifier '
      '(e.g. email) manually.',

  // Temporary fix, we should identifierErrorMap for this
  'identifier_invalid_format': 'Please enter a valid email address.',
  'identifier_already_in_use':
      'This email address is already taken. Please try another one or log in '
      'with this one.',
  'new_identifier_same_as_old': 'Please enter a new email address.',
};

/// Translates server error codes into human readable messages.
class Translator {
  /// Returns the translated message for the given [code].
  ...
  /// Returns the translated message for [code] specific to [identifierType].
  static String errorWithIdentifier(
    String code,
