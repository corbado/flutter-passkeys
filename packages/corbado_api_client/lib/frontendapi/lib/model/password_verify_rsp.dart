...
class PasswordVerifyRsp {
  ...
  @override
  String toString() =>
      'PasswordVerifyRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PasswordVerifyRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PasswordVerifyRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PasswordVerifyRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PasswordVerifyRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PasswordVerifyRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
