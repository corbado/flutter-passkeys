...
class EmailCodeStatusRsp {
  ...
  @override
  String toString() =>
      'EmailCodeStatusRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "EmailCodeStatusRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "EmailCodeStatusRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EmailCodeStatusRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<EmailCodeStatusRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EmailCodeStatusRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
