...
class PassKeyRegisterFinishRsp {
  ...
  bool operator ==(Object other) =>
      ...
      other is PassKeyRegisterFinishRsp &&
  ...
  @override
  String toString() =>
      'PassKeyRegisterFinishRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PassKeyRegisterFinishRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PassKeyRegisterFinishRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PassKeyRegisterFinishRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PassKeyRegisterFinishRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PassKeyRegisterFinishRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
