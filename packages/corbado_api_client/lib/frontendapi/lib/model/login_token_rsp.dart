...
class LoginTokenRsp {
  ...
  @override
  String toString() =>
      'LoginTokenRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "LoginTokenRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "LoginTokenRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<LoginTokenRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<LoginTokenRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = LoginTokenRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
