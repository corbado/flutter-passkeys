...
class PassKeyAppendFinishRspAllOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is PassKeyAppendFinishRspAllOf && other.data == data;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PassKeyAppendFinishRspAllOf[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PassKeyAppendFinishRspAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PassKeyAppendFinishRspAllOf> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PassKeyAppendFinishRspAllOf>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PassKeyAppendFinishRspAllOf.listFromJson(
          entry.value,
          growable: growable,
        );
      }
