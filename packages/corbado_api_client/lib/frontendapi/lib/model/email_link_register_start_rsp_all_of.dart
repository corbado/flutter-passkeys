...
class EmailLinkRegisterStartRspAllOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is EmailLinkRegisterStartRspAllOf && other.data == data;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "EmailLinkRegisterStartRspAllOf[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "EmailLinkRegisterStartRspAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EmailLinkRegisterStartRspAllOf> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<EmailLinkRegisterStartRspAllOf>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EmailLinkRegisterStartRspAllOf.listFromJson(
          entry.value,
          growable: growable,
        );
      }
