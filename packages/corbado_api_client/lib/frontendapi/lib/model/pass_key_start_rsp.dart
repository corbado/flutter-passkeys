...
class PassKeyStartRsp {
  ...
  @override
  String toString() =>
      'PassKeyStartRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PassKeyStartRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PassKeyStartRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PassKeyStartRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PassKeyStartRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PassKeyStartRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
