...
class EmailLinkLoginStartRsp {
  ...
  bool operator ==(Object other) =>
      ...
      other is EmailLinkLoginStartRsp &&
  ...
  @override
  String toString() =>
      'EmailLinkLoginStartRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "EmailLinkLoginStartRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "EmailLinkLoginStartRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EmailLinkLoginStartRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<EmailLinkLoginStartRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EmailLinkLoginStartRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
