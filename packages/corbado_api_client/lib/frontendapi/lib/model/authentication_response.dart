...
class AuthenticationResponse {
  ...
  @override
  String toString() =>
      'AuthenticationResponse[shortSession=$shortSession, longSession=$longSession, passkeyOperation=$passkeyOperation]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "AuthenticationResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "AuthenticationResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AuthenticationResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<AuthenticationResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AuthenticationResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
