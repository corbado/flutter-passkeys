...
class EmailLinkConfirmRspAllOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is EmailLinkConfirmRspAllOf && other.data == data;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "EmailLinkConfirmRspAllOf[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "EmailLinkConfirmRspAllOf[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EmailLinkConfirmRspAllOf> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<EmailLinkConfirmRspAllOf>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EmailLinkConfirmRspAllOf.listFromJson(
          entry.value,
          growable: growable,
        );
      }
