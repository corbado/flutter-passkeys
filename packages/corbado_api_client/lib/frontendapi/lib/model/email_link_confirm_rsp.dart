...
class EmailLinkConfirmRsp {
  ...
  @override
  String toString() =>
      'EmailLinkConfirmRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "EmailLinkConfirmRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "EmailLinkConfirmRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EmailLinkConfirmRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<EmailLinkConfirmRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EmailLinkConfirmRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
