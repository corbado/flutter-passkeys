...
class AuthMethodsListRsp {
  ...
  @override
  String toString() =>
      'AuthMethodsListRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "AuthMethodsListRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "AuthMethodsListRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AuthMethodsListRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<AuthMethodsListRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AuthMethodsListRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
