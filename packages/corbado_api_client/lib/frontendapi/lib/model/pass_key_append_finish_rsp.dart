...
class PassKeyAppendFinishRsp {
  ...
  bool operator ==(Object other) =>
      ...
      other is PassKeyAppendFinishRsp &&
  ...
  @override
  String toString() =>
      'PassKeyAppendFinishRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PassKeyAppendFinishRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PassKeyAppendFinishRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PassKeyAppendFinishRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PassKeyAppendFinishRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PassKeyAppendFinishRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
