...
class EmailCodeLoginStartRsp {
  ...
  bool operator ==(Object other) =>
      ...
      other is EmailCodeLoginStartRsp &&
  ...
  @override
  String toString() =>
      'EmailCodeLoginStartRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "EmailCodeLoginStartRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "EmailCodeLoginStartRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EmailCodeLoginStartRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<EmailCodeLoginStartRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EmailCodeLoginStartRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
