...
class PassKeyMediationStartRsp {
  ...
  bool operator ==(Object other) =>
      ...
      other is PassKeyMediationStartRsp &&
  ...
  @override
  String toString() =>
      'PassKeyMediationStartRsp[httpStatusCode=$httpStatusCode, message=$message, requestData=$requestData, runtime=$runtime, data=$data]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PassKeyMediationStartRsp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PassKeyMediationStartRsp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PassKeyMediationStartRsp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PassKeyMediationStartRsp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PassKeyMediationStartRsp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
