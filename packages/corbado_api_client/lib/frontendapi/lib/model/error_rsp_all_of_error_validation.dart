...
class ErrorRspAllOfErrorValidation {
  ...
  bool operator ==(Object other) =>
      ...
      other is ErrorRspAllOfErrorValidation &&
          other.field == field &&
  ...
  int get hashCode =>
      ...
      (field.hashCode) + (message.hashCode);

  @override
  String toString() =>
      'ErrorRspAllOfErrorValidation[field=$field, message=$message]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ErrorRspAllOfErrorValidation[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ErrorRspAllOfErrorValidation[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ErrorRspAllOfErrorValidation> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ErrorRspAllOfErrorValidation>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ErrorRspAllOfErrorValidation.listFromJson(
          entry.value,
          growable: growable,
        );
      }
