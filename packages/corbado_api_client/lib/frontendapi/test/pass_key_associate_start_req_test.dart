...
// tests for PassKeyAssociateStartReq
void main() {
  // final instance = PassKeyAssociateStartReq();

  group('test PassKeyAssociateStartReq', () {
    // String associationToken
    test('to test the property `associationToken`', () async {
      // TODO
    });
