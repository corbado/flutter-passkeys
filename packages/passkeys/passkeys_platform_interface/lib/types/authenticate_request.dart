...
/// The [AuthenticateRequestType] is used to create an authentication request
...
class AuthenticateRequestType {
  ...
  /// This is the maximum time the user has to respond to the authentication
  /// request.
  final int? timeout;
  ...
  /// The mediation type.
  /// This can be one of the following values:
  /// - `silent`: The authentication request is silent and does not require
  ///   user interaction.
  /// - `optional`: The authentication request is optional and may require
  ///   user interaction.
  /// - `conditional`: The authentication request is conditional and may require
  ///   user interaction.
  /// - `required`: The authentication request is required and must require
  ///   user interaction.
