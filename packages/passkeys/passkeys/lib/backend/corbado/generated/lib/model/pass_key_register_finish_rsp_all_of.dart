...
class PassKeyRegisterFinishRspAllOf {
  ...
  PassKeyRegisterFinishRspAllOfData data;
  ...
  static PassKeyRegisterFinishRspAllOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PassKeyRegisterFinishRspAllOf(
        data: PassKeyRegisterFinishRspAllOfData.fromJson(json[r'data'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<PassKeyRegisterFinishRspAllOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PassKeyRegisterFinishRspAllOf.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
