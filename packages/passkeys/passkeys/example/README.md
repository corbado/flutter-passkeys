...
log into your Google account and properly
set up a screen lock or biometrics on the device.

First, to log into your Google account, open settings, click on the icon in the top right and then
on "Sign in to your Google Account".
...
Secondly, to set up the screen lock, open the settings, search for security settings and add a PIN
